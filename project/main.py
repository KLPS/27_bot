...
class SoundBoard(commands.Cog):
    ...
    @commands.command(name="ga7bu")
    async def _function_ga7bu(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
              vc.play(discord.FFmpegPCMAudio(source="./audio/ga7bu.wav"))
            # Sleep while audio is playing.
              while vc.is_playing():
                  time.sleep(.1)
              await vc.disconnect()
    ...
    @commands.command(name="ali")
    async def _function_ali(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
              vc.play(discord.FFmpegPCMAudio(source="./audio/ali.wav"))
            # Sleep while audio is playing.
              while vc.is_playing():
                  time.sleep(.1)
              await vc.disconnect()
    ...
    @commands.command(name="louza")
    async def _function_louza(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
              vc.play(discord.FFmpegPCMAudio(source="./audio/louza.wav"))
            # Sleep while audio is playing.
              while vc.is_playing():
                  time.sleep(.1)
              await vc.disconnect()
    ...
    @commands.command(name="volva")
    async def _function_ya_volva(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
              vc.play(discord.FFmpegPCMAudio(source="./audio/volvzvagit.wav"))
            # Sleep while audio is playing.
              while vc.is_playing():
                  time.sleep(.1)
              await vc.disconnect()
    ...
    async def _function_lag(self, ctx):
          # Gets voice channel of message author
          voice_channel = ctx.author.voice.channel
          if voice_channel != None:
              vc = await voice_channel.connect()
              vc.play(discord.FFmpegPCMAudio(source="./audio/lag.wav"))
            # Sleep while audio is playing.
              while vc.is_playing():
                  time.sleep(.1)
              await vc.disconnect()
...
bot.run("ODA5OTM0MDIxMDU1NzQxOTUy.YCcT1g.kR04Wi4gohNzNbx9LW0NpP7bPR4")
